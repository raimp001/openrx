...
export default function Topbar() {
  ...
  const pageInfo = useMemo(() => {
    const entries: Array<[string, { label: string; note: string }]> = [
      ...
      ["/vitals", { label: "Vitals", note: "Blood pressure, glucose, and other measurements" }],
      ["/vaccinations", { label: "Vaccinations", note: "Immunization reminders and follow-up" }],
      ...
      ["/compliance-ledger", { label: "Compliance ledger", note: "Audit trail and disclosure controls" }],
      ["/second-opinion", { label: "Second opinion", note: "Specialist review preparation" }],
      ["/timeline", { label: "Timeline", note: "Your care events in sequence" }],
      ["/emergency-card", { label: "Emergency card", note: "Critical information for urgent care" }],
      ["/wallet", { label: "Wallet", note: "Optional wallet settings and payment rails" }],
      ["/join-network", { label: "Join network", note: "Provider onboarding and verification" }],
      ["/admin-review", { label: "Admin review", note: "Manual review and compliance operations" }],
