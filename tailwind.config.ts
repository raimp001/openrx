...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        card: "0 1px 2px rgba(15,23,42,0.05), 0 4px 14px rgba(15,23,42,0.05)",
        "card-hover": "0 1px 2px rgba(15,23,42,0.06), 0 8px 22px rgba(15,23,42,0.08)",
        "soft-card": "0 6px 20px rgba(15,23,42,0.07)",
        topbar: "0 1px 0 rgba(15,23,42,0.04)",
