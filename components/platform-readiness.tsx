  ...
  return (
    <section className="surface-card overflow-hidden">
      <div className="grid gap-0 lg:grid-cols-[0.92fr_1.08fr]">
        <div className="border-b border-zinc-200 bg-white p-5 lg:border-b-0 lg:border-r">
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              disabled={refreshing}
              className="inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white/[0.06] px-3 py-2 text-[11px] font-semibold text-white/72 transition hover:bg-white/[0.1] disabled:opacity-60"
            >
...
function ReadinessMiniStat({
  ...
  return (
    <div className="rounded-[20px] border border-zinc-200 bg-zinc-50 p-3">
      ...
      <p className="mt-3 text-lg font-semibold tracking-normal text-zinc-900">{value}</p>
    </div>
  )
}
