...
export function createDemoSnapshot(walletAddress?: string | null): LiveSnapshot {
  ...
  const patient: LivePatient = {
    ...
    insurance_id: "BCB-9927-7731",
    emergency_contact_name: "Alex Rivera",
    emergency_contact_phone: "555-867-5310",
    medical_history: [
      { condition: "Type 2 Diabetes (well-controlled)", diagnosed: "2019-03-10", status: "active" },
      { condition: "Hypertension", diagnosed: "2020-08-22", status: "active" },
      { condition: "Hyperlipidemia", diagnosed: "2020-08-22", status: "active" },
      { condition: "Seasonal Allergies", diagnosed: "2010-04-01", status: "active" },
    ],
  ...
  const messages: LiveMessage[] = [
    {
      ...
      content: "Hi Jordan — your A1C came back at 6.8%, which is well-controlled. Let's review at your upcoming visit. Keep up the great work with the Metformin!",
      channel: "portal",
      read: true,
      created_at: d(-14),
    },
